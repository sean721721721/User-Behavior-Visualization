...
class Graph extends Component {
  ...
  drawwithlabels() {
    function communityInnerMatrixReordering(mat, communityData) {
      let copyMat = mat.slice();
      communityData.forEach((com) => {
        const onlyCommunity = [];
        for (let i = 0; i < com.num; i += 1) {
    ...
    function matrixReordering(mat, origMat) {
    ...
    const gropuIndex = [
      { community: 0, num: 24, index: 0 },
      { community: 1, num: 12, index: 23 },
      { community: 2, num: 14, index: 34 },
    ]
    ...
    for (let i = 0; i < 31; i += 1) {
      t1.push(tMat[i + 118].slice(118, 118 + 31));
    }
    // console.log(t1);
    const [a1, m11] = matrixReordering(t1, tMat);
    // console.log(a1, m11);
    const [a2, m2] = matrixReordering(a1, m11);
    // console.log(a2, m2);
    const [a3, m3] = matrixReordering(a2, m2);
    // console.log(a3, m3);

    // a1 = [];
    // console.log(a1, m11);
    // for (let i = 0; i < m11.length; i += 1) {
    //   // console.log(i);
    //   const temp = m11[i].slice();
    //   // console.log(temp);
    //   if (i >= 18 && i < 30) {
    //     temp.fill(0, 0, 18);
    //     temp.fill(0, 30);
    ...
    // }
    // console.log(a1);
    // const [a11, m111] = matrixReordering(a1, m11);
    // console.log(a11, m111);
    ...
    const graph = reorder.mat2graph(mat1);
    let perms = reorder.pca_order(mat1);
	  // let bfs = reorder.all_pairs_distance_bfs(graph);
    ...
    // console.log(perms);
    let permuted = reorder.permute(mat1, perms);
