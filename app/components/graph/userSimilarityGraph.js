  ...
  function doTest() {
    ...
    for (let i = 0; i < mat1[0].length; i += 1) {
          for (let j = 0; j < mat1[0].length; j += 1) {
            if (i < 9 && j < 9) {
              mat1[i][j] = {com: 1, value: Math.min(getRandomArbitrary(0.5, 1), 1)};
            }
            else if ((i >= 9 && i < 16) && (j >= 9 && j < 16)) {
              mat1[i][j] = {com: 2, value: Math.min(getRandomArbitrary(0.5, 1), 1)}
            }
            else if (i >= 16 && j >= 16) {
              mat1[i][j] = {com: 3, value: Math.min(getRandomArbitrary(0.5, 1), 1)};
            } else {
    ...
    // const remat = dp.testMatrixReordering(randomMat);
    const remat = [
      [
        {
          "com": 2,
